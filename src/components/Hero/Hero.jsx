        ...
        <div className="container text-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <motion.div
              ...
              className='w-[90%] md:w-[400px] mx-auto px-4 py-2 mt-6 md:mt-12 bg-white dark:bg-black text-black dark:text-white rounded-2xl shadow-md'
            >
              <div>
